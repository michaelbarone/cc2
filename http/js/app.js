const app = angular.module("ControlCenter", [
  "ngSanitize",
  "ngRoute",
  "ngResource",
  "ngIdle",
...
app.config([
  ...
  "KeepaliveProvider",
  "IdleProvider",
  function ($routeProvider, $controllerProvider, informProvider, KeepaliveProvider, IdleProvider) {
    /* routes */
...
app.run(function ($rootScope, $location, userService, Idle, cron) {
  ...
  const routespermission = ["/dashboard", "/settings"];
